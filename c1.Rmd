...
opts_chunk$set(dpi=200, prompt=TRUE, comment=NA, upload.fun=imgur_upload)
require(siggenes)
...
xtable(table(mgse_COMBAT$Disease, mgse_COMBAT$Study))
```
...
xtable(table(c1.data$Disease, c1.data$Study))
```
